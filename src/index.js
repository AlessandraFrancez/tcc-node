...
class App {
  constructor() {
    ...
    this.socketServer = require('./src/commons/factorys/socket.factory');
    ...
    this.soatokenscheduler = require('./src/commons/utils/soatokenscheduler');
    this.cors = require('cors');
    this.soatokenscheduler;
  ...
  middlewares() {
    ...
    this.express.use(this.rateLimiting.index);
  ...
  // socket() {
  //   const EventsSockets = require('./src/socket');
  //   EventsSockets.initialize();
  // }
